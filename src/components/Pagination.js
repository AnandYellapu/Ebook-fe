...
//         <li className={`page-item ${currentPage === Math.ceil(totalBooks / booksPerPage) ? 'disabled' : ''}`}>
//           <button onClick={() => paginate(currentPage + 1)} className="page-link">
//             Next
//           </button>
//         </li>
...
//         <li className={`page-item ${currentPage === Math.ceil(totalBooks / booksPerPage) ? 'disabled' : ''}`}>
//           <button onClick={() => paginate(Math.ceil(totalBooks / booksPerPage))} className="page-link">
//             Last
//           </button>
//         </li>
//       </ul>
